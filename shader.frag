...
void main() {
	...
	k+=gabor(p, 0.05, 0.00, 1.89, 1.08, 3.65, 0.14, 0.13, 2.00);
	k+=gabor(p, -0.60, 1.00, 3.26, 2.84, 3.72, 0.58, 0.58, 0.23);
	k+=gabor(p, 0.03, -0.21, 1.60, 1.52, 3.12, 0.10, 0.10, 1.65);
	k+=gabor(p, 0.47, 1.00, 6.28, 2.33, 4.00, 0.53, 0.53, 0.19);
	k+=gabor(p, 0.30, -0.00, 4.39, 6.27, 0.36, 0.14, 0.14, 0.12);
	k+=gabor(p, 0.05, -0.12, 3.17, 1.22, 0.41, 0.18, 0.06, 0.16);
	k+=gabor(p, 1.00, -0.63, 4.75, 4.04, 1.14, 1.17, 0.15, 0.20);
	k+=gabor(p, -1.00, -0.23, 4.03, 3.94, 1.29, 0.54, 0.54, 0.06);
	k+=gabor(p, 0.15, -0.09, 1.60, 6.28, 0.21, 0.06, 0.06, 0.20);
	k+=gabor(p, -0.49, 0.47, 5.45, 1.03, 0.76, 0.38, 0.38, 0.06);
